...
if __name__=='__main__':
    ...
    #model_params
    model_params = {
        "MODEL": "GPT_outputs_test/model_files",  # model_type: t5-base/t5-large
    ...
    GPTTest(dataframe=df, source_text="story", target_text="ending", model_params=model_params, output_dir=output_dir)