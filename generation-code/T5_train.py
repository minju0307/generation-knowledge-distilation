...
if __name__=='__main__':
    ...
    df = df[:10]
    df["story"] = "Write the ending of the following story: " + df["sentence1"] + ' ' + df["sentence2"] + ' ' + df[
        "sentence3"] + ' ' + df["sentence4"]
    df["ending"] = df["sentence5"]
    console.print(df['story'][0])
    console.print(df['ending'][0])

    #load test dataset
    df2 = pd.read_csv("data/ROCStories_winter2017.csv")
    df2 = df2[:100]
    df2["story"] = "Write the ending of the following story: " + df2["sentence1"] + ' ' + df2["sentence2"] + ' ' + df2[
        "sentence3"] + ' ' + df2["sentence4"]
    df2["ending"] = df2["sentence5"]
    console.print(df2['story'][0])
    console.print(df2['ending'][0])
    ...
    output_dir='T5_outputs_0shot_defaul_prompt'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    T5Trainer(dataframe=df, test_dataframe=df2, source_text="story", target_text="ending", model_params=model_params, output_dir=output_dir)