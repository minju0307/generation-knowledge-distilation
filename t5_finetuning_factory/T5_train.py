...
if __name__=='__main__':
    ...
    #load dataset
    df = pd.read_csv(f"data/{cli_args.task}/{cli_args.task}_train.csv", sep=',')
    ...
    #load test dataset
    df2 = pd.read_csv(f"data/{cli_args.task}/{cli_args.task}_dev.csv", sep=',')
    ...
    output_dir=f'{cli_args.model}_{cli_args.task}_{cli_args.sampling}'
